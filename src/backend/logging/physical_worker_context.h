...
//                         Peloton
//
// physical_worker_context.h
//
// Identification: src/backend/logging/physical_worker_context.h
//
...
namespace logging {
  ...
  struct PhysicalWorkerContext {

    PhysicalWorkerContext(oid_t id)
