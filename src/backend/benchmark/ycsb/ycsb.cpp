...
static void WriteOutput() {
  ...
  // } else {
    LOG_INFO("%lf tps, %lf; %lf tps, %lf; %lf tps, %lf, %d",
             state.throughput, state.abort_rate, state.reverse_throughput, state.reverse_abort_rate, state.scan_throughput, state.scan_abort_rate, state.snapshot_memory[state.snapshot_throughput.size() - 1]);
  // }
  ...
  out << state.reverse_throughput << " ";
  out << state.reverse_abort_rate << " ";
