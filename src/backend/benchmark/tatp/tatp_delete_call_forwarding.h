...
class DeteteCallForwarding : public concurrency::TransactionQuery {
 public:
  DeteteCallForwarding()
      : sub_index_scan_executor_(nullptr),
        call_del_index_scan_executor_(nullptr),
        call_del_executor_(nullptr),
        context_(nullptr),
  ...
  void SetContext(executor::ExecutorContext* context) {
    ...
    call_del_index_scan_executor_->SetContext(context);
    call_del_executor_->SetContext(context);
  ...
  virtual void Cleanup() {
    ...
    delete call_del_index_scan_executor_;
    call_del_index_scan_executor_ = nullptr;

    delete call_del_executor_;
    call_del_executor_ = nullptr;
  }
  ...
  */
  ...
  virtual void UpdateRunTableSingleRef(int queue_no,
    ...
    // SUB_NBR
    //////////////////////////////////////////////////////////////////////
    std::string key = std::string("SUB_NBR") + "-" + std::to_string(sid_);
 ...
 public:
  ...
  executor::IndexScanExecutor* call_del_index_scan_executor_;
  executor::DeleteExecutor* call_del_executor_;
