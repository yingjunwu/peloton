...
//                         Peloton
//
// ts_order_sv_txn_manager.h
//
// Identification: src/backend/concurrency/ts_order_sv_txn_manager.h
//
...
class TsOrderSVTxnManager : public TransactionManager {
 public:
  ...
  virtual ~TsOrderSVTxnManager() {}

  static TsOrderSVTxnManager &GetInstance();
