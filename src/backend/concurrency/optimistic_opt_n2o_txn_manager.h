...
//                         Peloton
//
// optimistic_opt_n2o_txn_manager.h
//
// Identification: src/backend/concurrency/optimistic_opt_n2o_txn_manager.h
//
...
class OptimisticOptN2OTxnManager : public TransactionManager {
public:
  OptimisticOptN2OTxnManager() {}

  virtual ~OptimisticOptN2OTxnManager() {}

  static OptimisticOptN2OTxnManager &GetInstance();
