...
extern thread_local cid_t tcrb_latest_read_timestamp;
...
class TsOrderCentralRbTxnManager : public TransactionManager {
public:
  ...
  cid_t GetLatestReadTimestamp() {
    return tcrb_latest_read_timestamp;
  }
  ...
  virtual Transaction *BeginTransaction() {
    ...
    tcrb_latest_read_timestamp = begin_cid;
  ...
  virtual void EndTransaction() {
    ...
    tcrb_updated_index_entries.clear();
    delete current_txn;
    current_txn = nullptr;
  }
  ...
  static inline storage::RollbackSegmentPool *GetSegmentPool() {
