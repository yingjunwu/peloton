...
//                         Peloton
//
// ts_order_opt_n2o_txn_manager.h
//
// Identification: src/backend/concurrency/ts_order_opt_n2o_txn_manager.h
//
...
class TsOrderOptN2OTxnManager : public TransactionManager {
 public:
  TsOrderOptN2OTxnManager() {}

  virtual ~TsOrderOptN2OTxnManager() {}

  static TsOrderOptN2OTxnManager &GetInstance();
