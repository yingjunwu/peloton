...
do
for proto in {occn2o,pccn2o,ewn2o,ton2o};
do
for gc in n2otxn;
do
LD_PRELOAD=/home/yingjun/jemalloc/lib/libjemalloc.so timeout 120 ./src/ycsb -z ${skew} -u ${update} -b ${core_cnt} -p ${proto} -g ${gc} -o ${opt} -k 40000 -e -P20 -L20 > /dev/null;
