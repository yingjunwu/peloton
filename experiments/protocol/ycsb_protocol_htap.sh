...
LD_PRELOAD=/home/yingjun/jemalloc/lib/libjemalloc.so timeout 120 ./src/ycsb -z ${skew} -u ${update} -b ${total_core_cnt} -v ${ro_core_cnt} -p ${proto} -g ${gc} -o ${opt} -k 1000 -e > /dev/null;
