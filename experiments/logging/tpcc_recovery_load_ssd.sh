...
./cleanup_log.log
# command logging
LD_PRELOAD=/home/yingjun/jemalloc/lib/libjemalloc.so ./src/tpcc -w40 -l20 -b32 -t1 -k1 -e -a -f10 -n -L command -D /data/ -C off -F /data/,/data/ -T dist -d 60 -I100 -goff
...
./cleanup_log.log
# phylog logging
LD_PRELOAD=/home/yingjun/jemalloc/lib/libjemalloc.so ./src/tpcc -w40 -l20 -b32 -t1 -k1 -e -a -f10 -n -L phylog -D /data/ -C off -F /data/,/data/ -T dist -d 60 -I100 -goff
...
./cleanup_log.log
# physical logging
LD_PRELOAD=/home/yingjun/jemalloc/lib/libjemalloc.so ./src/tpcc -w40 -l20 -b32 -t1 -k1 -e -a -f10 -n -L physical -D /data/ -C off -F /data/,/data/ -T dist -d 60 -I100 -goff
